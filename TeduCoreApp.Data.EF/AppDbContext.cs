...
namespace TeduCoreApp.Data.EF
{
    public class AppDbContext : IdentityDbContext<AppUser, AppRole, Guid>
    {
        ...
        /// <summary>
        /// Định nghĩa các liên kết giữa db và model
        /// </summary>
        ...
        /// <summary>
        /// Hàm này sẽ tạo ra các quy định về trường dữ liệu cho các thuộc tính không thể định nghĩa bằng Annotation
        /// và sẽ được gọi khi dùng appdbcontext
        /// </summary>
        /// <param name="builder"></param>
        protected override void OnModelCreating(ModelBuilder builder)
        {
            //đổi tên cho các bảng mặc định của Identity
